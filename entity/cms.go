...
type CmsPage struct {
	...
	Config            *CmsPageConfig `json:"config,omitempty"` // map[properties:map[backgroundColor:map[type:string]] type:object]
	CreatedAt         *time.Time     `json:"createdAt,omitempty"`
	CustomFields      *[]CustomField `json:"customFields,omitempty"`
...
// CmsPageConfig helper data structure
type CmsPageConfig struct {
	BackgroundColor *string `json:"backgroundColor,omitempty"`
}
