...
type Product struct {
	...
	OptionIds                     *[]string                            `json:"optionIds,omitempty"` // map[items:map[pattern:^[0-9a-f]{32}$ type:string] readOnly:true type:array]
	...
	PropertyIds                   *[]string                            `json:"propertyIds,omitempty"`    // map[items:map[pattern:^[0-9a-f]{32}$ type:string] readOnly:true type:array]
...
type ProductReview struct {
	...
	Language         *Language      `json:"language,omitempty"`
	LanguageId       *string        `json:"languageId,omitempty"`
	Points           *float64       `json:"po*ints,omitempty"`
	Product          *Product       `json:"product,omitempty"`
	ProductId        *string        `json:"productId,omitempty"`
	ProductVersionId *string        `json:"productVersionId,omitempty"`
	SalesChannel     *SalesChannel  `json:"salesChannel,omitempty"`
...
type ProductSearchConfig struct {
	...
	CreatedAt       *time.Time                `json:"createdAt,omitempty"`
	ExcludedTerms   *[]string                 `json:"excludedTerms,omitempty"` // map[items:map[type:string] type:array]
	Id              *string                   `json:"id,omitempty"`
	Language        *Language                 `json:"language,omitempty"`
	LanguageId      *string                   `json:"languageId,omitempty"`
